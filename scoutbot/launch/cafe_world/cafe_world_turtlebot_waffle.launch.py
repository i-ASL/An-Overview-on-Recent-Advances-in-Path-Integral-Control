...
def generate_launch_description():
  package_name = 'scoutbot'
  robot_name_in_model = 'turtlebot3_waffle'
  default_launch_dir = 'launch'
  gazebo_models_path = 'models'
  map_file_path = 'maps/cafe_world/cafe_world.yaml'
  nav2_params_path = 'params/cafe_world/nav2_params_tb3_waffle.yaml'
  rviz_config_file_path = 'rviz/cafe_world/nav2_default_view.rviz'
  sdf_model_path = 'models/turtlebot3_waffle/model.sdf'

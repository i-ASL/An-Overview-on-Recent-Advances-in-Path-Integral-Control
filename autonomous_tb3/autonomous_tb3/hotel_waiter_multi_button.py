...
class NavigatorApp:
    ...
    def set_initial_pose(self):
        ...
        initial_pose.pose.position.x = -5.0
        initial_pose.pose.position.y = 0.51
        initial_pose.pose.orientation.z =0.0
        initial_pose.pose.orientation.w =0.01
        self.navigator.setInitialPose(initial_pose)
        self.navigator.waitUntilNav2Active()

        self.go_to_pose(-4.85,-3.0)
    ...
    def go_to_pose(self,x,y):
        ...
        counter_return.pose.position.x =-4.85
        counter_return.pose.position.y =-3.0
